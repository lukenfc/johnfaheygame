...
var birthdayMessages = [
  {
    name: 'Aidan',
    message: 'happy birthday uncle jack',
  },
  {
    name: 'Aman',
    message: '20 is a pathway to many abilities some consider to be unnatural... Happy Birthday',
  },
  {
    name: 'Connor',
  ...
  {
    name: 'Eli',
    message: 'Happy birthday Jackson, thanks for being a goof and making me laugh',
  },
  {
    name: 'Elliot',
    message: 'Happy birthday, StEp-BrO ;)',
  },
  {
    name: 'Giorgo',
    message: 'Happy Birthday Jackson!!',
  },
  {
    name: 'Jacob',
  ...
  {
    name: 'Kyden',
    message: 'Happy birthday Jackson! Thanks for teaching me your master-grilling techniques and always being down for a milkshake run. Have an awesome day.',
  },
  {
    name: 'Luke',
  ...
  {
    name: 'Seth',
    message: 'Happy Birthday king, stay numpty',
  }
]
...
var applause = new Sound('applause.mp3')
...
function startGame(){
  if(performed){
    fadeOut = setInterval(()=>{
      if(applause.sound.volume > 0){
        applause.sound.volume -= 0.1
      }
      else{
        clearInterval(fadeOut)
